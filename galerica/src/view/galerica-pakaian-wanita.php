            ...
            <div id=div3>
                        ...
                        <?php
                            if ($isiHalamanAktif==$isiJumlahHalaman){
                                ...
                                echo "<td id=tampilData>";
                                    echo "Menampilkan <button id=buttonTampilData disabled> $awalData-$isiJumlahData </button> dari $isiJumlahData <i class='fas fa-angle-double-right'></i>";
                                echo "</td>";
                            }
                            else{
                                $awalData = $isiAwalData + 1;
                                ...
                                echo "<td id=tampilData>";
                                    echo "Menampilkan <button id=buttonTampilData disabled> $awalData-$akhirData </button> dari $isiJumlahData <i class='fas fa-angle-double-right'></i>";
                                echo "</td>";
                            }
                        ?>
                        <td id=search>
                            <form action="../controller/search-pakaian-wanita-controller.php" method="post">
                ...
                <div align=center style="padding-bottom: 10px;">
                    <div class="row" align=center>
                        <?php 
                        foreach ($isiPakaianWanita as $data) {?>
                    ...
                    <tr>
                        <?php
                            ...
                            if ($isiHalamanAktif==1){
                                ...
                                echo "<td id=td29>";
                                    echo "<a href='pakaian-wanita-controller.php?page=$halamanSebelumnya' style='text-decoration: none; color: black;'>";
                                        echo "<i class='fas fa-chevron-circle-left'></i> Halaman Sebelumnya";
                                    echo "</a>";
                                echo "</td>";
                            }
                            if ($isiHalamanAktif==$isiJumlahHalaman){
                                ...
                                echo "<td id=td30>";
                                    echo "<a href='pakaian-wanita-controller.php?page=$halamanSelanjutnya' style='text-decoration: none; color: black;'>";
                                        echo "Halaman Selanjutnya <i class='fas fa-chevron-circle-right'></i>";
                                    echo "</a>";
                                echo "</td>";
                            }
